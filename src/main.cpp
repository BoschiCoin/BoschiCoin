...
// Copyright (c) 2013-2014 BoschiCoin Developers
...
uint256 hashGenesisBlock("0xe052f02636050aad4d7c6da49299afa7ef9f1a5dd1ba16861916e6d165e027f1");
...
const string strMessageMagic = "BoschiCoin Signed Message:\n";
...
{
    int64 nSubsidy = 84 * COIN;
    nSubsidy >>= (nHeight / 420000);
    return nSubsidy+nFees;
}

static const int64 nTargetTimespan = 120; // BoschiCoin: Every two blocks
static const int64 nTargetSpacing = 60; // BoschiCoin: 62 second blocks
    ...
    if (BlockLastSolved == NULL || BlockLastSolved->nHeight == 0 || (uint64)BlockLastSolved->nHeight < PastBlocksMin) { return bnProofOfWorkLimit.GetCompact(); }
        ...
        for (unsigned int i = 1; BlockReading && BlockReading->nHeight > 0; i++) {
                ...
                if (LatestBlockTime < BlockReading->GetBlockTime()) {
                  if (BlockReading->nHeight > 40000) LatestBlockTime = BlockReading->GetBlockTime();
                }
                PastRateActualSeconds                   = LatestBlockTime - BlockReading->GetBlockTime();
                PastRateTargetSeconds = TargetBlocksSpacingSeconds * PastBlocksMass;
                PastRateAdjustmentRatio = double(1);
                //if (PastRateActualSeconds < 0) { PastRateActualSeconds = 0; }
                 if (BlockReading->nHeight > 40000) {
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal boschicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BoschiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe052f02636050aad4d7c6da49299afa7ef9f1a5dd1ba16861916e6d165e027f1");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Boschicoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1393504570; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2507496;

        if (fTestNet)
        {
            block.nTime    = 1393504570;
            block.nNonce   = 2507496;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xdb6fc5b74b3ba7d2c3a6f94bbb421385b6ae7bc3554583a40c863ff5e8ea6305"));
